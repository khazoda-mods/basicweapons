...
public class CustomSwordItem extends BasicWeaponItem {
  public CustomSwordItem(ToolMaterial material, float attackDamage, float attackSpeed, double reach, Item.Properties properties) {
